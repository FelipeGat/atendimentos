        ...
        img.onload = () => {
            try {
                    ...
                    for (let regionX = 0; regionX < 3; regionX++) {
                        ...
                        for (let y = startY; y < endY; y++) {
                            for (let x = startX; x < endX; x++) {
                                ...
                                // Filtrar cores "corporativas" - evitar amarelos/laranjas muito claros
                                if (r > 200 && g > 150 && b < 100) continue; // Filtrar amarelos/laranjas claros
                ...
                colorCandidates.forEach(color => {
                    // Priorizar cores verdes, azuis e outras cores corporativas
                    let corporateBonus = 1.0;
                    
                    // Bonus para verdes
                    if (color.g > color.r && color.g > color.b && color.g > 80) {
                        corporateBonus = 1.5;
                    }
                    // Bonus para azuis
                    else if (color.b > color.r && color.b > color.g && color.b > 80) {
                        corporateBonus = 1.4;
                    }
                    // Penalizar amarelos/laranjas muito claros
                    else if (color.r > 180 && color.g > 140 && color.b < 80) {
                        corporateBonus = 0.5;
                    }
                    
                    const totalScore = color.regionScore * corporateBonus * color.saturation;
